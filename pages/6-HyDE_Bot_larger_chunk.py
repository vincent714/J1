...
st.title("HyDE Chatbot  (larger chunk)")
st.write(
...
if "messages_4_larger" not in st.session_state:
    st.session_state.messages_4_larger = []

# Display chat messages from history on app rerun
for message in st.session_state.messages_4_larger:
...
if prompt := st.chat_input():
    ...
    st.session_state.messages_4_larger.append({"role": "user", "content": prompt})
    ...
    st.session_state.messages_4_larger.append({"role": "ai", "content": results})
